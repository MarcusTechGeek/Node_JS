...
app.get("/contact", homeController.showSignUp); // Handle GET request for /contact route
app.post("/contact", homeController.postedContactForm); // Handle POST request for /contact route
